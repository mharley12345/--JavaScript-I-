...
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
                    ...
                    const car_make = inventory.filter(function (inventory) {
                    console.log('The make is'+(inventory.faction = " Lincoln "));
                    });
                        var car_model = inventory.filter(function (inventory) {
                            console.log('The model is'+ (inventory.faction =" Town Car"));
...
////// ///////////////////////////////////////////////////////////Challenge 3 ////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 {"id":50,"car_make":"Lincoln","car_model":"Town Car","car_year":1999}];
                            ...
                            if (nameA < nameB) 
                            console.log(carModels);              //sort string ascending
                                return -1;
                            if (nameA > nameB)
